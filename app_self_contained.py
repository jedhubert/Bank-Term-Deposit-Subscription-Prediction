...
def get_model():
    ...
    possible_paths = ['train (3).csv', 'train.csv', '../train.csv', 'data/train.csv']
    train_path = None
...
with st.sidebar:
    ...
    page = st.radio("Choose a page:", ["🎯 Single Prediction", "📊 Batch Prediction", "📈 Model Info", "ℹ️ About"])
    ...
    if metadata:
        ...
        st.markdown(f"**Last Trained:** {metadata['train_date']}")
...
# Page: About
    ...
    - **Cost Optimization**: Reduce unnecessary outreach efforts
    - **Strategic Decisions**: Data-driven insights for campaign planning
    ...
    1. **Single Prediction**: Enter individual customer details
    2. **Batch Prediction**: Upload CSV for bulk predictions
    3. **Model Info**: View performance metrics
    
    ### 💡 Interpretation
    
    - **Probability > 70%**: High priority - immediate follow-up
    - **Probability 40-70%**: Medium priority - targeted campaigns
    - **Probability < 40%**: Low priority - nurture via other channels
    
    ---
    
    **Version**: 1.0.0 | **Self-Contained Edition**
    """)
...
st.markdown(
    ...
    <div style='text-align: center; color: gray; padding: 1rem;'>
        🏦 Bank Term Deposit Prediction System | Powered by Machine Learning<br>
